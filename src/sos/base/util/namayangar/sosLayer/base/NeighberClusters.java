...
public class NeighberClusters extends SOSAbstractToolsLayer<ClusterData> {

	public NeighberClusters() {
	...
	protected void makeEntities() {
		ArrayList<ClusterData> list = ((PoliceForceAgent) (model().me().getAgent())).getState(OpenCivilianState.class).neighberCluster;
		setEntities(list);
	}
