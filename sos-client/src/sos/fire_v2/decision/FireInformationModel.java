...
public class FireInformationModel extends SOSInformationModel {
	...
	public FireInformationModel(SOSAgent<? extends Human> agent) {
		...
		setFireZoneSelector(new SOSFireZoneSelector((FireBrigadeAgent) agent,(MapClusterType<FireBrigade>) ((FireBrigadeAgent) agent).newSearch.getSearchWorld().getMapClusterType()));
