...
//				return 1;
	...
	public void chooseAllMessages() {
		...
		chooseHumanMessages();
		model().sosAgent().sosLogger.act.info(" choosing HumanMessages got:" + (System.currentTimeMillis() - t1) + "ms");t1 = System.currentTimeMillis();
		chooseFireMessages();
		model().sosAgent().sosLogger.act.info(" choosing FireMessages got:" + (System.currentTimeMillis() - t1) + "ms");t1 = System.currentTimeMillis();
		chooseRoadMessages();
		model().sosAgent().sosLogger.act.info(" choosing RoadMessages got:" + (System.currentTimeMillis() - t1) + "ms");t1 = System.currentTimeMillis();
		chooseSearchForCivilianBuildings();
		model().sosAgent().sosLogger.act.info(" choosing SearchForCivilian got:" + (System.currentTimeMillis() - t1) + "ms");t1 = System.currentTimeMillis();
