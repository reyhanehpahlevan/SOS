...
public final class CommandLineOptions {
	 ...
	 * @param config
	 *            A Config to populate.
	 * @return All unprocessed options. This will not be null.
	 * @throws IOException
	 *             If there is a problem reading a config file.
	 * @throws ConfigException
	 *             If there is a problem processing a config file.
	 */
	public static String[] processArgs(String[] args, Config config) throws IOException, ConfigException {
		...
		while (it.hasNext()) {
			...
			} else if (HOST_FLAG.trim().equalsIgnoreCase(next.trim())) {
