...
public class SenseSelectedLaye extends SOSAbstractToolsLayer<StandardEntity> {

	private int radius;

	public void initialise(Config config) {
		super.initialise(config);
		radius = config.getIntValue("perception.los.max-distance");
	}

	@Override
	public String getName() {
		return "Sense Selected Layer";
	}

	public SenseSelectedLaye() {
