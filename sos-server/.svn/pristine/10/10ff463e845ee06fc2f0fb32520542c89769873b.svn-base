    ...
    public void timestep() throws InterruptedException, KernelException, LogException {
        try {
            ...
            synchronized (this) {
                ...
                Logger.debug("Waiting for commands:"+(System.currentTimeMillis()-start)+" after peception:"+(System.currentTimeMillis()-perceptionTime));
                ...
                System.out.println("Timestep "+time +": score="+s);
    ...
    */
    public void shutdown() {
        synchronized (this) {
            ...
            Logger.info("Kernel is shutting down ====>score="+score.score(getWorldModel(), previousTimestep));
            System.out.println("Kernel is shutting down ====>score="+score.score(getWorldModel(), previousTimestep));
