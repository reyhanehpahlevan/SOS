    ...
    */
    public static void main(String[] args) {
        ...
        try {
            ...
            EncodingTools.IS_COMPRESSION_ENABLED=config.getBooleanValue(Constants.COMPRESSION_KEY,EncodingTools.IS_COMPRESSION_ENABLED);
			...
			Logger.fatal("Scenario Exception");
		}
    }
    ...
    private static void setToolkit() {
    		try {
    			Toolkit xToolkit = Toolkit.getDefaultToolkit();
    			  ...
    			  awtAppClassNameField.set(xToolkit, "Kernel");
    			} catch (Exception e1) {
    			}
	}
