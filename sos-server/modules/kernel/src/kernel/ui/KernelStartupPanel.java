...
public class KernelStartupPanel extends JPanel {
    ...
    */
    ...
    private static final class CheckboxPanel extends JPanel {
        private CheckboxPanel(Collection<? extends Component> available1, final KernelStartupOptions options) {
        	ArrayList<?extends Component>available=new ArrayList<Component>(available1);
        	Collections.sort(available, new Comparator<Component>() {
				@Override
    ...
    private static final class SpinnerPanel extends JPanel {
        private SpinnerPanel(Collection<? extends Component> available1, final KernelStartupOptions options) {
        	ArrayList<?extends Component>available=new ArrayList<Component>(available1);
        	Collections.sort(available, new Comparator<Component>() {
				@Override
				public int compare(Component o1, Component o2) {
