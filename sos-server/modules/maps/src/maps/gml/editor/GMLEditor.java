...
public class GMLEditor extends JPanel {
    ...
    */
    public static void main(String[] args) {
        ...
        args=new String[]{"/home/sos/Desktop/sos-server/boot/maps/test/KobeSlice/map/map.gml"};
    ...
    */
    ...
    private void createViewActions(JMenu menu, JToolBar toolbar) {
        ...
        Action clearValidate= new AbstractAction("Clear Validate") {
                @Override
                public void actionPerformed(ActionEvent e) {
        ...
        toolbar.add(clearValidate);        
        menu.add(resetZoom);
        menu.add(clearValidate);
